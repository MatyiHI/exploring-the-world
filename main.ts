...
sprites.onOverlap(SpriteKind.Player, SpriteKind.teleporter, function (sprite, otherSprite) {
    ...
    if (Level == 1) {
        ...
        mySprite3.setPosition(75, 19)
        game.showLongText("omg a minion", DialogLayout.Bottom)
        game.showLongText("go to the minion", DialogLayout.Bottom)
        game.showLongText("hello i am the minion named goggle boyyyy!!!", DialogLayout.Bottom)
        game.showLongText("I lost a gold coin that my friend gave to me can you please help me find it?", DialogLayout.Bottom)
...
game.showLongText("Hello welcome to my world!", DialogLayout.Bottom)
game.showLongText("Let me show you around", DialogLayout.Bottom)
game.showLongText("go to the bubble", DialogLayout.Bottom)
Level = 1
mySprite.sayText(Level)
forever(function () {
    music.play(music.stringPlayable("C - D C - G - - ", 120), music.PlaybackMode.UntilDone)
