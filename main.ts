...
mySprite.sayText("Hello welcome to my world", 2000, false)
mySprite.sayText("in this world you can do what ever u want", 2000, false)
forever(function () {
    music.play(music.stringPlayable("E B C5 A B G A F ", 120), music.PlaybackMode.UntilDone)
    music.play(music.stringPlayable("E - D - F E D C ", 120), music.PlaybackMode.UntilDone)
    music.play(music.stringPlayable("D - G - A - F E ", 120), music.PlaybackMode.UntilDone)
    music.play(music.stringPlayable("D G C - - - - - ", 120), music.PlaybackMode.UntilDone)
})
